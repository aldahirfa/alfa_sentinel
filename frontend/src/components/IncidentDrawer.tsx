...
export default function IncidentDrawer({ selected, assignableUsers, onClose, onChanged }: Props) {
  ...
  return (
    <>
      ...
      />
      <aside
        className="fixed top-0 right-0 h-screen w-full sm:w-[460px] z-50 flex flex-col"
        style={{
          background: "var(--surf)",
                  ...
                  {data.incident_id ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 py-2 rounded-lg text-[12.5px] font-semibold cursor-pointer disabled:opacity-50"
